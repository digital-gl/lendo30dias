  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#D4AF37]/30">
      ...
      <section className="pt-2 pb-8 px-6 flex flex-col items-center text-center bg-[radial-gradient(50%_50%_at_50%_50%,_#FFFFFF_0%,_#FFF4CC_100%)]">
        ...
        <a
          href="#oferta"
          className="bg-gradient-to-r from-green-600 to-emerald-400 hover:from-green-700 hover:to-emerald-500 text-white font-black text-lg py-4 px-10 rounded-2xl shadow-[0_10px_30px_rgba(34,197,94,0.4)] uppercase tracking-tight w-full max-w-md inline-block text-center animate-pulse-sm hover:scale-105 active:scale-95 transition-transform"
        >
      ...
      <section className="py-24 px-6 bg-white relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="mt-16 text-center">
            <a
              href="#oferta"
              className="inline-block bg-gradient-to-r from-green-600 to-emerald-400 hover:from-green-700 hover:to-emerald-500 text-white font-black text-sm md:text-base py-5 px-8 rounded-2xl shadow-[0_10px_30px_rgba(34,197,94,0.4)] hover:scale-105 active:scale-95 transition-all uppercase tracking-tight"
            >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {[
              ...
              <div 
                key={i}
                className="bg-white p-4 md:p-5 rounded-[2rem] shadow-xl border border-slate-100 flex flex-col md:flex-row items-center gap-4"
              >
                <div className="w-full md:w-56 aspect-square bg-slate-100 rounded-2xl overflow-hidden shrink-0">
