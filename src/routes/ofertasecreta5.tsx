...
function Countdown() {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      setTime((t) => {
        if (t.m === 0 && t.s === 0) return { m: 9, s: 59 };
...
function OfertaSecreta5Page() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#D4AF37]/30">
      {/* Top alert bar */}
      <div className="bg-red-700 text-white py-2.5 text-center text-xs md:text-sm font-black uppercase tracking-wider sticky top-0 z-50 flex items-center justify-center gap-2">
        <AlertTriangle className="w-4 h-4 animate-pulse" />
        OFERTA ULTRA SECRETA — SÓ QUEM CHEGOU AQUI PODE VER
      </div>
      ...
      <section className="py-10 md:py-16 px-6 flex flex-col items-center text-center bg-gradient-to-b from-[#FFFBEB] to-white">
        ...
        <h1 className="text-3xl md:text-6xl font-extrabold max-w-4xl leading-tight mb-6 tracking-tight">
          Espera, mãe... Não vá embora. Abrimos <span className="text-[#D4AF37]">a condição MAIS barata</span> que já fizemos.
        </h1>

        <p className="text-lg md:text-2xl text-slate-600 max-w-3xl mb-8 leading-relaxed">
          Como você chegou até aqui, decidimos abrir <strong>uma exceção única</strong>. O <strong>Plano Premium completo</strong> + os <strong>6 bônus exclusivos</strong> por um preço que <strong className="text-red-600">não existe em nenhum outro lugar</strong>.
        </p>

        {/* Countdown */}
        <div className="mb-8">
          <p className="text-xs md:text-sm font-black text-red-600 uppercase tracking-widest mb-3">
            ⏳ Essa página se autodestroi em:
          </p>
          <Countdown />
          <p className="text-xs text-slate-500 font-medium mt-3 max-w-sm mx-auto">
            Após o tempo expirar, o link some para sempre e o preço volta para R$ 59,90.
          </p>
        </div>

        {/* Price card */}
        <div className="relative max-w-md w-full mb-8">
          <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-[#D4AF37] rounded-[2.5rem] blur opacity-50 animate-pulse" />
          <div className="relative bg-white p-8 rounded-[2.5rem] border-4 border-red-600 shadow-[0_30px_60px_rgba(220,38,38,0.25)]">
            <div className="inline-block bg-red-700 text-white px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-3">
              Desconto impossível — Back-redirect final
            </div>
            <p className="text-slate-500 line-through text-xl font-bold">De R$ 19,90</p>
            ...
            <div className="flex items-baseline justify-center gap-1 mb-2">
              ...
              <motion.span
                ...
                className="text-7xl md:text-8xl font-black text-red-600 inline-block tabular-nums"
                style={{ textShadow: "0 8px 30px rgba(220,38,38,0.5)" }}
              >
                5,00
              </motion.span>
            </div>
            <p className="text-emerald-600 font-black text-sm uppercase tracking-tighter mb-6">
              Você economiza R$ 14,90 agora
            </p>
      ...
      <section className="py-14 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <span className="inline-block bg-red-600 text-white px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-3">
          ...
          <div className="bg-white rounded-[2rem] shadow-xl border border-slate-100 p-6 md:p-10 space-y-5">
            ...
            <div className="border-t border-dashed border-slate-200 pt-5 mt-5 text-center">
              ...
              <p className="text-5xl font-black text-red-600">R$ 5,00</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-gradient-to-b from-white to-[#FFFBEB] text-center">
        <div className="max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-red-700 text-white px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest mb-6">
            <Clock className="w-4 h-4 animate-pulse" />
            Última chance — essa página some depois do timer
          </div>

          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 tracking-tight leading-tight">
            Por R$ 5,00 você muda a história escolar do seu filho.
          </h2>
          <p className="text-slate-600 text-lg mb-8 leading-relaxed">
            Menos de <strong>R$ 0,17 por dia</strong> durante um mês para ele finalmente <strong>ler sozinho</strong>, ganhar autoestima e parar de sofrer na hora da tarefa.
          </p>
